...
async function getPendingPage() {
   try {
      ...
      if (searchForm.regionCode) params.regionCode = searchForm.regionCode;

      const res = await apis.getPendingList(params);
