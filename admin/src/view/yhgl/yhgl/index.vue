<template>
   <DefaultContainer>
      ...
      <div class="menu-box">
         <div class="right">
            <ElButton type="primary" style="margin-right: 10px" @click="router.push(`/yhgl/yhgl/form`)">
               新增用户
            </ElButton>
...
import * as apis from '@/api/yhgl/yhgl.ts';
...
async function exportHandler() {
   try {
      ...
      link.href = url;
      link.download = `用户列表${new Date().getTime()}.xlsx`;
